...
from invblock import INV_block_affine, INV_block_affine_new
...
class Hinet_stage1(nn.Module):
    ...
    def __init__(self):
        ...
        self.inv1 = INV_block_affine(imp_map=False)  # imp_map不可用，M=8
...
class Hinet_stage3(nn.Module):
    '''Residual in Residual Dense Block'''

    def __init__(self):
        super(Hinet_stage3, self).__init__()

        self.inv1 = INV_block_affine_new()
        self.inv2 = INV_block_affine_new()
        self.inv3 = INV_block_affine_new()
        self.inv4 = INV_block_affine_new()
        self.inv5 = INV_block_affine_new()
        self.inv6 = INV_block_affine_new()
        self.inv7 = INV_block_affine_new()
        self.inv8 = INV_block_affine_new()

        self.inv9 = INV_block_affine_new()
        self.inv10 = INV_block_affine_new()
        self.inv11 = INV_block_affine_new()
        self.inv12 = INV_block_affine_new()
        self.inv13 = INV_block_affine_new()
        self.inv14 = INV_block_affine_new()
        self.inv15 = INV_block_affine_new()
        self.inv16 = INV_block_affine_new()
